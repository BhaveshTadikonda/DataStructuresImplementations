...
public class BinarySearchTree<T extends Comparable<T>> {
  ...
  private java.util.Iterator<T> preOrderTraversal(){
      ...
      return java.util.Iterator<T>(){
          ...
          public boolean hasNext(){
              if(expectedCount!=nodeCount) throw new java.util.concurrentModificationExpection();
  ...
  private java.util.Iterator<T> postOrderTraversal(){
      ...
      return new java.util.Iterator<T>(){
          @Override
          public boolean hasNext(){
             if(expectedCount!= nodeCount) throw new java.util.ConcurrentModificationException();
